...
use rentsyst\admin\Rentsyst_Admin;
use rentsyst\site\Rentsyst_Site;
...
class Rentsyst {
	 ...
	 * @access   private
	 */
	private function load_site_components() {

		$plugin_public = new Rentsyst_Site();

		add_action('init', [$plugin_public, 'init']);
