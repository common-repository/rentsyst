...
let buttonBlockName = 'core/button';
...
function Edit(_ref) {
  ...
  const preferredStyle = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    var _preferredStyleVariat;

    const preferredStyleVariations = select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.store).getSettings().__experimentalPreferredStyleVariations;
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__.registerBlockType)('rentsyst/vehicle-reservation-button', {
  icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_6__["default"],
  example: {
    innerBlocks: [{
      name: 'core/button',
      attributes: {
        text: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Find out more')
      }
    }, {
      name: 'core/button',
      attributes: {
        text: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Contact us')
      }
    }]
  },
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"rentsyst/vehicle-reservation-button","version":"0.6.0","title":"Vehicle reserve button","category":"rentsyst","description":"This block give opportunity to display reservation button for each item of vehicle","keywords":["link"],"icon":"button","textdomain":"rentsyst","attributes":{"selectedType":{"type":"string","default":false}},"supports":{"anchor":true,"align":["wide","full"],"__experimentalExposeControlsToChildren":true,"spacing":{"blockGap":true,"margin":["top","bottom"],"__experimentalDefaultControls":{"blockGap":true}},"__experimentalLayout":{"allowSwitching":false,"allowInheriting":false,"default":{"type":"flex"}}},"styles":[{"name":"fill","label":"Fill","isDefault":true},{"name":"outline","label":"Outline"}],"usesContext":["postId","postType","queryId"],"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrentsyst_block_post_custom_field"] = self["webpackChunkrentsyst_block_post_custom_field"] || [];
