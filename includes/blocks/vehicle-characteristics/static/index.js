...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getSwitchUtilityClass": function() { return /* binding */ getSwitchUtilityClass; }
/* harmony export */ });
/* harmony import */ var _mui_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @mui/base */ "./node_modules/@mui/utils/esm/generateUtilityClass/generateUtilityClass.js");
/* harmony import */ var _mui_base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @mui/base */ "./node_modules/@mui/utils/esm/generateUtilityClasses/generateUtilityClasses.js");
...
/* harmony default export */ __webpack_exports__["default"] = (switchClasses);
...
/* harmony import */ var _optionsField__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./optionsField */ "./src/optionsField.js");
...
function Edit(_ref) {
  ...
  if (postType && postId) {
    meta = wp.data.select('core').getEntityRecord('postType', 'vehicle', postId)['meta'];

    if (meta[selectedField]) {
      selectedFieldValue = meta[selectedField];
    }
  }
  ...
  let options = [{
    ...
    render: function (value) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.ColorIndicator, {
        colorValue: '#' + value
      });
    }
  }, {
    ...
    label: 'Prices by periods',
    value: 'periods_price'
  }, {
    label: 'Insurance Deposit',
    value: 'insurance_deposit'
  }, {
    label: 'Engine volume',
    value: 'volume_engine'
  }, {
    ...
    label: 'Options',
    value: 'options_data',
    render: function (optionsJson) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_optionsField__WEBPACK_IMPORTED_MODULE_7__["default"], {
  ...
  for (let option of options) {
    if (option.value === selectedField) {
      if (!selectedFieldValue) {
        selectedFieldValue = option.label;
        break;
      } else if (option.hasOwnProperty('render')) {
        selectedFieldValue = option.render(selectedFieldValue);
      }
    }
  }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_4__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_4__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, {
    key: "setting"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Panel, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelBody, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.SelectControl, {
    class: "block-meta-field-selector",
    options: options,
    label: 'Select custom field',
    value: selectedField,
    onChange: handleSelect
  }))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, selectedField && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, selectedFieldValue), !selectedField && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Placeholder, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Vehicle parameters block", "twentytwentytwo")
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('rentsyst/vehicle-characteristics', {
  /**
   * @see ./edit.js
   */
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_easy_sort__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! react-easy-sort */ "./node_modules/react-easy-sort/index.module.js");
...
/* harmony import */ var _mui_material_FormGroup__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @mui/material/FormGroup */ "./node_modules/@mui/material/FormGroup/FormGroup.js");
/* harmony import */ var _mui_material_FormControlLabel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @mui/material/FormControlLabel */ "./node_modules/@mui/material/FormControlLabel/FormControlLabel.js");
/* harmony import */ var _mui_material_FormHelperText__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @mui/material/FormHelperText */ "./node_modules/@mui/material/FormHelperText/FormHelperText.js");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(_ref) {
  ...
  let currentVehicleOptions = JSON.parse(optionsJson);
  let listOfOptions = [];

  function fillListOfOption() {
    let result = [];

    for (let activeOption of optionsSetting.activeOptions) {
      for (let currentOption of currentVehicleOptions) {
        if (activeOption === currentOption.id) {
          result.push({
            name: currentOption.name,
            icon: currentOption.icon
          });

          if (result.length === optionsSetting.limit) {
            return result;
          }
        }
      }
  ...
  listOfOptions = fillListOfOption();
  let fullListOfOptions = {
    air_condition: {
      key: 'air_condition',
      title: 'Air Condition'
    },
    ...
    climate_control_two_zones: {
      key: 'climate_control_two_zones',
      title: 'Climate Control two zones'
    },
    luxury_climate_control: {
      key: 'luxury_climate_control',
      title: 'Luxury climate control'
    },
    sunroof: {
      key: 'sunroof',
      title: 'Sunroof'
    ...
    proximity_key_entry_system: {
      key: 'proximity_key_entry_system',
      title: 'Proximity key entry system'
    },
    rear_parking_sensors: {
      key: 'rear_parking_sensors',
    ...
    built_in_sat_nav: {
      key: 'built_in_sat_nav',
      title: 'Built-in sat nav'
    },
    mobile_phone_technology: {
      key: 'mobile_phone_technology',
    ...
    qi_wireless_charging: {
      key: 'qi_wireless_charging',
    ...
    active_parking_assist: {
      key: 'active_parking_assist',
      title: 'Active parking assist'
    },
    automatic_high_beams: {
      key: 'automatic_high_beams',
  ...
  const onSortEnd = (oldIndex, newIndex) => {
    optionsSetting.activeOptions = array_move__WEBPACK_IMPORTED_MODULE_1___default()(optionsSetting.activeOptions, oldIndex, newIndex);
    setAttributes({
      optionsSetting: lodash_clonedeep__WEBPACK_IMPORTED_MODULE_5___default()(optionsSetting)
    });
  };

  const handleChange = event => {
    let new_setting = [...optionsSetting.activeOptions];

    if (event.target.checked) {
      new_setting.push(event.target.name);
    } else {
      new_setting = optionsSetting.activeOptions.filter(e => e !== event.target.name);
    }

    optionsSetting.activeOptions = new_setting;
    setAttributes({
      optionsSetting: lodash_clonedeep__WEBPACK_IMPORTED_MODULE_5___default()(optionsSetting)
    });
  };
  ...
  const handleLimit = value => {
    optionsSetting.limit = parseInt(value);
    setAttributes({
      optionsSetting: lodash_clonedeep__WEBPACK_IMPORTED_MODULE_5___default()(optionsSetting)
    });
  };

  const handleSwitchIcon = event => {
    optionsSetting.displayIcon = event.target.checked;
    setAttributes({
      optionsSetting: lodash_clonedeep__WEBPACK_IMPORTED_MODULE_5___default()(optionsSetting)
    });
  };

  const handleSwitchHideTitle = event => {
    optionsSetting.hideTitle = event.target.checked;
    setAttributes({
      optionsSetting: lodash_clonedeep__WEBPACK_IMPORTED_MODULE_5___default()(optionsSetting)
    });
  };
  ...
  const handleDisplayType = selectedValue => {
    optionsSetting.displayType = selectedValue;
    setAttributes({
      optionsSetting: lodash_clonedeep__WEBPACK_IMPORTED_MODULE_5___default()(optionsSetting)
    });
  };

  const handleSetDelimiter = event => {
    optionsSetting.itemDelimiter = event.target.value;
    setAttributes({
      optionsSetting: lodash_clonedeep__WEBPACK_IMPORTED_MODULE_5___default()(optionsSetting)
    });
  };
  ...
  for (let option of optionsSetting.activeOptions) {
    if (fullListOfOptions.hasOwnProperty(option)) {
      fullListOfOptions[option].checked = true;
      resultList.push(fullListOfOptions[option]);
    }
  }

  for (const key in fullListOfOptions) {
    if (!optionsSetting.activeOptions.includes(key)) {
      fullListOfOptions[key].checked = false;
      resultList.push(fullListOfOptions[key]);
    }
  }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(DisplayOptions, {
    itemDelimiter: optionsSetting.itemDelimiter,
    displayType: optionsSetting.displayType,
    displayIcon: optionsSetting.displayIcon,
    hideTitle: optionsSetting.hideTitle,
    items: listOfOptions
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_4__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorControls, {
    key: "setting"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.__experimentalNumberControl, {
    isDragEnabled: true,
    max: 30,
    min: 1,
    value: optionsSetting.limit,
    label: 'Set limit of displayed options',
    onChange: handleLimit
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
    class: "display-type-selector",
    options: displayTypeList,
    label: 'Select display type',
    value: optionsSetting.displayType,
    onChange: handleDisplayType
  }), optionsSetting.displayType === 'inline' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material__WEBPACK_IMPORTED_MODULE_6__["default"], {
    class: "rentsyst-option-inline-delimiter",
    label: 'Delimiter between items',
    value: optionsSetting.itemDelimiter,
    onChange: handleSetDelimiter
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material_FormControlLabel__WEBPACK_IMPORTED_MODULE_7__["default"], {
    control: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material_Switch__WEBPACK_IMPORTED_MODULE_8__["default"], {
      checked: optionsSetting.displayIcon,
      onChange: handleSwitchIcon
    }),
    label: "Display icon"
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material_FormControlLabel__WEBPACK_IMPORTED_MODULE_7__["default"], {
    control: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material_Switch__WEBPACK_IMPORTED_MODULE_8__["default"], {
      checked: optionsSetting.hideTitle,
      onChange: handleSwitchHideTitle
    }),
    label: "Hide title"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material_FormControl__WEBPACK_IMPORTED_MODULE_9__["default"], {
    component: "fieldset",
    variant: "standard"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material_FormLabel__WEBPACK_IMPORTED_MODULE_10__["default"], {
    component: "legend"
  }, "Display settings"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material_FormHelperText__WEBPACK_IMPORTED_MODULE_11__["default"], null, "Enable/disable and sort options that you want to be display"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material_FormGroup__WEBPACK_IMPORTED_MODULE_12__["default"], null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_easy_sort__WEBPACK_IMPORTED_MODULE_13__["default"], {
    onSortEnd: onSortEnd,
    className: "list",
    draggedItemClassName: "dragged"
  }, resultList.map(item => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_easy_sort__WEBPACK_IMPORTED_MODULE_13__.SortableItem, {
    key: item.key
...
function DisplayOptions(props) {
  ...
  const itemDelimiter = props.itemDelimiter;
  const hideTitle = props.hideTitle;
  const displayType = props.displayType;

  if (displayType === 'list') {
    const listItems = items.map(item => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, displayIcon && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
      className: 'fico rentsyst-option-icon fico-' + item.icon,
      title: item.name
    }), !hideTitle && item.name));
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
      className: "rentsyst-option-list"
    }, listItems);
  } else {
    const listItems = items.map(item => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, displayIcon && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
      className: 'fico rentsyst-option-icon fico-' + item.icon,
      title: item.name
    }), !hideTitle && item.name, itemDelimiter && items[items.length - 1] !== item && itemDelimiter));
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "rentsyst-options_wrap"
    }, listItems);
  }
}
...
/* harmony export */   "SortableKnob": function() { return /* binding */ SortableKnob; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ "./node_modules/react-easy-sort/node_modules/tslib/tslib.es6.js");
...
var useDrag = function useDrag(_a) {
  ...
  var _b = react__WEBPACK_IMPORTED_MODULE_1___default().useState(false),
      isTouchDevice = _b[0],
      setTouchDevice = _b[1];
...
var SortableList = function SortableList(_a) {
  var children = _a.children,
      ...
      rest = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__rest)(_a, ["children", "allowDrag", "onSortEnd", "draggedItemClassName", "as", "lockAxis", "customHolderRef"]); // this array contains the elements than can be sorted (wrapped inside SortableItem)
